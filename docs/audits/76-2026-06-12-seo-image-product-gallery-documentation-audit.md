...
- [docs/audits/51-2026-05-14-seo-image-documentation-cleanup.md](51-2026-05-14-seo-image-documentation-cleanup.md) — помечен как исторический snapshot, чтобы старый product пример через `seo-image` не воспринимался как текущая инструкция.
