...
- корневой `llms.txt` существует, написан как Markdown, имеет H1, дату обновления, ссылки на ключевые страницы, серии и все товарные страницы в украинской и русской версиях;
