...
> Исторический документ. Текущий project pin после обновления — `Hugo 0.164.0`; актуальный аудит синхронизации находится в [93-2026-07-07-hugo-0-164-update-audit.md](93-2026-07-07-hugo-0-164-update-audit.md).
...
Архивный аудит `42-2026-04-29-hugo-0-161-compliance-audit.md` оставлен как исторический документ и помечен как superseded. Его нельзя использовать как текущую инструкцию по версиям.
...
- `docs/audits/67-2026-05-26-hugo-0-162-compliance-audit.md`
...
- `docs/audits/47-2026-05-07-documentation-refresh-and-project-action-plan.md`
- `docs/audits/50-2026-05-13-documentation-2026-best-practices-sync-audit.md`
- `docs/audits/52-2026-05-15-documentation-full-audit.md`
...
- `docs/audits/42-2026-04-29-hugo-0-161-compliance-audit.md`
