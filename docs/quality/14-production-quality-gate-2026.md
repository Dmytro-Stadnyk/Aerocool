...
- Контактную форму без согласия нельзя отправить из браузера; сохраненная Netlify Forms submission содержит `privacy_consent=accepted` и актуальную `privacy_policy_version`.
...
- политика конфиденциальности опубликована в двух языках, формы не содержат заранее отмеченного согласия, а production database получила все pending migrations;
