...
- Документы `42–99` — исторические аудиты. Их выводы верны для указанной в имени даты и не описывают автоматически текущее состояние.
- Документ `100` — единственный текущий полный аудит на 2026-07-13.
...
## 4. Исторические аудиты: 42–99

Эти документы сохраняют ход решений и доказательства на конкретную дату. Не используйте слово `current` в старом английском имени как гарантию актуальности: текущим считается только аудит `100`.
...
100. `docs/audits/100-2026-07-13-full-documentation-project-sync-audit-current.md` — текущая полная проверка структуры, языка, ссылок, фактов, сборки и синхронизации с проектом.
