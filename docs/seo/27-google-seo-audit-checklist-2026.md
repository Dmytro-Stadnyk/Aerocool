...
> Практический порядок для проекта задают этот чек-лист, [production gate](../quality/14-production-quality-gate-2026.md) и [технический контракт `hugo.yaml`](36-hugo-yaml-serp-technical-contract-2026.md). Аудиты `47` и `50` сохраняют историю прежнего плана.
...
| Имя файла | Для основной обложки page bundle использовать `01-front.webp`; глобальным файлам давать описательные имена, а не `img123` |
