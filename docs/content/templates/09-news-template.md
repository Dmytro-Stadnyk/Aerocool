...
- Перед добавлением нового визуального материала проверить [руководство по изображениям](../34-image-design-playbook-2026.md) и актуальный аудит из [карты документации](../../01-documentation-map.md#5-текущий-аудит): приоритет имеет официальный доказательный материал, а не дополнительная AI-сцена.
